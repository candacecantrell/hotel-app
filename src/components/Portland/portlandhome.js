...
import portlandHero from '../../assets/Photos/portlandHero.jpg';

class PortlandHome extends Component {
    constructor(props) {
        super(props);
        this.state = {
            error: null,
    ...
    render() {
        ...
        if (error) {
          ...
          return (
            ...
            {hotelData.slice(1,2).map((hotel, key) =>
            <div key={key}>
        <HotelDataCard

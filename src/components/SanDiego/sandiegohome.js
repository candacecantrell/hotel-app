...
import sandiegoHero from '../../assets/Photos/sandiegoHero.jpg';

class SanDiegoHome extends Component {
    constructor(props) {
        super(props);
        this.state = {
            error: null,
    ...
    render() {
        ...
        if (error) {
          ...
          return (
            ...
            {hotelData.slice(0,1).map((hotel, key) =>
            <div key={key}>
        <HotelDataCard
